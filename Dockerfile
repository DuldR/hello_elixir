...
COPY --from=builder --chown=nobody:root /app/tailscaled /app
COPY --from=builder --chown=nobody:root /app/tailscale /app/
COPY --from=builder --chown=nobody:root /var/run/tailscale /var/run/tailscale 
COPY --from=builder --chown=nobody:root /var/cache/tailscale /var/cache/tailscale 
COPY --from=builder --chown=nobody:root /var/lib/tailscale /var/lib/tailscale 
